...
public class MouseClickEntity extends entity{
	...
	public MouseClickEntity(screen mainscreen, double x, double y, game maingame, String button, String event) {
	...
	public void draw(){
		...
		mainscreen.screengraphics.drawString((new CVector2D(x, y)).getString(), (int)x+7, (int)y-10);
	}
